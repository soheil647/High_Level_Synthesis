...
//  always@(posedge clk) begin
//    if(rst)
//      in_rsc_singleport_addr<=0;
//    else
//    in_rsc_singleport_addr <= in_rsc_singleport_addr + 1;
//  end
//  always@(posedge out_rsc_singleport_we)begin
//    if(rst)
//      out_rsc_singleport_addr<=0;
//    else
//    out_rsc_singleport_addr <= out_rsc_singleport_addr+1;
//  end
