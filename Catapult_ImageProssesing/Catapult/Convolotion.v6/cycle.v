...
//  Generated date: Sat Apr 20 18:25:08 2019
// ----------------------------------------------------------------------
...
module Convolotion_core (
  ...
  always begin : core
    ...
    reg [10:0] conv1_sva;
    reg [10:0] conv2_sva;
    reg for_for_for_for_lor_1_lpi_2_dfm;
      ...
      forever begin : main
        ...
        begin : for_0Exit
          forever begin : for_0
            ...
            Krow_1_sva = 2'b0;
            for_for_stage_0 = 1'b1;
            for_for_stage_0_1 = 1'b1;
            begin : for_forExit
              forever begin : for_for
                ...
                if ( for_for_stage_0_1 ) begin
                  ...
                  conv1_sva = conv_s2s_3_11(conv_u2s_2_3(Kcolumn_1_sva) + 3'b111)
                      + conv_u2s_9_11(Dcolumn_1_sva_2);
                  conv2_sva = conv_s2s_2_11(Krow_1_sva + 2'b11) + conv_u2s_9_11(Drow_1_sva_2);
                  for_for_for_for_lor_1_lpi_2_dfm = (conv2_sva[10]) | (conv1_sva[9])
                      | (conv1_sva[10]);
                  if ( for_for_for_for_lor_1_lpi_2_dfm ) begin
                  end
                  else begin
                    for_for_for_for_lor_sva_1 = readslicef_2_1_1(((~ (conv2_sva[10:9]))
                        + 2'b1));
                  end
                  for_for_for_for_lor_lpi_2_dfm = for_for_for_for_lor_sva_1 | for_for_for_for_lor_1_lpi_2_dfm;
                  if ( for_for_for_for_lor_lpi_2_dfm ) begin
                  end
                  else begin
                ...
                if ( for_for_stage_0_1 ) begin
                  ...
                  if ( for_for_for_for_lor_lpi_2_dfm ) begin
                    ...
                    for_for_for_for_else_mux_1_itm = MUX_s_1_16_2({1'b0 , 1'b0 ,
                        ...
                        , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0}, {for_for_for_for_else_acc_7_psp
                        , (for_for_for_for_else_acc_6_sdt[0])});
                  end
                  ...
                  exit_for_for_lpi_2_dfm = (Drow_1_sva_1[9]) & exit_for_for_for_1_sva;
                  if ( exit_for_for_lpi_2_dfm ) begin
                    for_for_stage_0 = 1'b0;
                  end
                  else begin
                    Drow_1_sva_2 = MUX_v_9_2_2({Drow_1_sva_2 , (Drow_1_sva_1[8:0])},
                        exit_for_for_for_1_sva);
                    Krow_1_sva = Krow_1_sva_dfm_1 & (signext_2_1(~ exit_for_for_for_1_sva));
                    Kcolumn_1_sva = Kcolumn_1_sva_dfm & (signext_2_1(~ exit_for_for_for_1_sva));
                    exit_for_for_for_sva = exit_for_for_for_sva_dfm_1 & (~ exit_for_for_for_1_sva);
                  end
                end
                ...
                Result_sg1_sva_dfm_1 = Result_sg1_sva_dfm;
                ...
                begin : unreg_outs_lp_2Exit
                  forever begin : unreg_outs_lp_2
                    ...
                    Result_sg1_sva_dfm = Result_sg1_sva_dfm_1;
                ...
                if ( for_for_stage_0_1 ) begin
                  if ( exit_for_for_lpi_2_dfm ) begin
                    ...
                    Result_sg2_sva = Result_sg2_sva_dfm & (~ exit_for_for_for_1_sva);
                    Result_sg1_sva = Result_sg1_sva_dfm & (signext_6_1(~ exit_for_for_for_1_sva));
                    Result_1_sva = Result_1_sva_dfm & (~ exit_for_for_for_1_sva);
                  end
                end
                if ( ~(for_for_stage_0 | for_for_stage_0_1) )
                  disable for_forExit;
                for_for_stage_0_1 = for_for_stage_0;
              end
            end
            in_rsc_singleport_addr_reg_1 <= 9'b0;
            in_rsc_singleport_addr_reg_sg1 <= 9'b0;
