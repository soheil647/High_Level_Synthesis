...
//  Generated date: Sat Apr 20 18:22:45 2019
// ----------------------------------------------------------------------
...
module Convolotion_core_fsm (
  ...
  always @(st_for_1_tr0 or state_var)
...
module Convolotion_core (
  ...
  wire [2:0] fsm_output;
  wire [9:0] for_acc_1_tmp;
  wire [10:0] xfor_acc_1_tmp;
  ...
  reg [1:0] Krow_1_sva;
  reg for_for_for_for_lor_lpi_1_dfm;
  reg exit_for_for_for_1_sva;
  reg exit_for_for_1_sva;
  reg exit_for_lpi_1_dfm;
  reg for_stage_0;
  ...
  wire exit_for_for_sva_dfm_1_mx0;
  ...
  Convolotion_core_fsm Convolotion_core_fsm_inst (
      ...
      .st_for_1_tr0((~(for_stage_0_1 | for_stage_0)))
    );
  assign and_85_cse = (fsm_output[2]) & (~ (fsm_output[0]));
  assign and_61_cse = (for_for_for_for_acc_itm[1]) & or_dcpl_22;
  assign nor_8_m1c = ~(and_dcpl_54 | and_dcpl_56);
  assign nor_30_tmp = ~((((~(((~ and_dcpl_63) & or_dcpl_45) | (and_dcpl_63 & for_for_for_for_lor_lpi_1_dfm)))
      | and_dcpl_65) & and_85_cse) | (fsm_output[0]));
  assign and_120_tmp = (~ for_for_for_for_lor_lpi_1_dfm) & and_dcpl_63 & and_85_cse;
  assign exit_for_for_for_1_sva_1 = (~ (for_for_for_for_acc_itm[1])) & exit_for_for_for_sva_dfm_1_mx0;
  assign xfor_for_for_for_acc_1_tmp = conv_s2s_3_11(conv_u2s_2_3(Kcolumn_1_sva) +
      3'b111) + conv_u2s_9_11(Dcolumn_1_sva_2);
  assign for_for_for_for_acc_1_tmp = xfor_for_for_for_acc_1_tmp[10:0];
  assign xfor_for_for_for_oelse_2_acc_itm = (~ (z_out[10:9])) + 2'b1;
  assign for_for_for_for_oelse_2_acc_itm = xfor_for_for_for_oelse_2_acc_itm[1:0];
  assign xfor_acc_1_tmp = conv_u2u_9_10(Dcolumn_1_sva_2) + 10'b1;
  assign for_acc_1_tmp = xfor_acc_1_tmp[9:0];
  assign exit_for_for_sva_dfm_1_mx0 = MUX_s_1_2_2({(for_for_acc_3_tmp[9]) , exit_for_for_sva},
      or_dcpl_22);
  assign xfor_for_acc_3_tmp = conv_u2u_9_10(Drow_1_sva_3) + 10'b1;
  ...
  assign exit_for_for_1_sva_1 = exit_for_for_for_1_sva_1 & exit_for_for_sva_dfm_1_mx0;
  ...
  assign for_for_for_for_else_ac_fixed_cctor_sva = (z_out[7:0]) | (signext_8_1(z_out[8]));
  assign or_dcpl_22 = (for_for_for_for_acc_itm[1]) | (for_for_for_acc_itm[1]);
  assign or_dcpl_45 = (~ for_stage_0_1) | exit_for_lpi_1_dfm;
  assign in_rsc_singleport_addr = {((z_out[8:0]) + conv_s2u_2_9(for_for_for_for_acc_1_tmp[10:9]))
      , (for_for_for_for_acc_1_tmp[8:0])};
  assign in_rsc_singleport_re = ~(for_stage_0_1 & (~ (for_for_for_for_oelse_2_acc_itm[1]))
      & (~ (for_for_for_for_acc_1_tmp[9])) & (~((for_for_for_for_acc_1_tmp[10]) |
      (z_out[10]))) & (fsm_output[1]));
  assign mux_20_nl = MUX_v_6_2_2({(for_for_for_for_else_ac_fixed_cctor_sva[6:1])
      , Result_sg1_sva}, for_for_for_for_lor_lpi_1_dfm);
  assign out_rsc_singleport_data_in = {Result_sg2_sva_dfm_mx0 , (mux_20_nl) , Result_1_sva_dfm_mx0};
  assign out_rsc_singleport_addr = {Drow_slc_Drow_1_itm , Dcolumn_slc_Dcolumn_1_itm};
  assign out_rsc_singleport_we = ~(for_stage_0_1 & exit_for_for_for_1_sva & (fsm_output[2]));
  assign and_dcpl_54 = (((for_for_acc_3_tmp[9]) & (~ or_dcpl_22)) | ((~ (for_for_for_for_acc_itm[1]))
      & or_dcpl_22)) & for_stage_0_1 & (~ exit_for_for_1_sva_1);
  assign and_dcpl_56 = ((~((for_for_acc_3_tmp[9]) | or_dcpl_22)) | exit_for_for_1_sva_1)
      & for_stage_0_1;
  assign and_dcpl_63 = (reg_Drow_1_sva_1_tmp | (~ exit_for_for_for_1_sva)) & (~(exit_for_for_1_sva
      | or_dcpl_45));
  assign and_dcpl_65 = ~((~(((~ reg_Drow_1_sva_1_tmp) & exit_for_for_for_1_sva) |
      exit_for_for_1_sva)) | or_dcpl_45);
  assign slc_exs_7_tmp_tmp = ~(for_stage_0_1 & exit_for_for_1_sva_1);
  always @(posedge clk) begin
    if ( rst ) begin
      for_stage_0 <= 1'b0;
      ...
      Result_sg1_sva <= 6'b0;
      Result_sg2_sva <= 1'b0;
      exit_for_lpi_1_dfm <= 1'b0;
      exit_for_for_for_1_sva <= 1'b0;
      for_for_for_for_lor_lpi_1_dfm <= 1'b0;
      exit_for_for_1_sva <= 1'b0;
      ...
      for_stage_0 <= (for_stage_0 & (~(for_stage_0_1 & (~ (for_for_for_for_acc_itm[1]))
          & (~ (for_for_for_acc_itm[1])) & (for_for_acc_3_tmp[9]) & (for_acc_1_tmp[9])
          & (fsm_output[1])))) | (fsm_output[0]);
      Dcolumn_1_sva_2 <= (MUX_v_9_2_2({(for_acc_1_tmp[8:0]) , Dcolumn_1_sva_2}, (~((~((~
          for_stage_0_1) | (for_for_for_for_acc_itm[1]) | (for_for_for_acc_itm[1])
          | (~ (for_for_acc_3_tmp[9])))) | (fsm_output[2]))) | (fsm_output[2])))
          & (signext_9_1(~ (fsm_output[0])));
      Drow_1_sva_3 <= (MUX_v_9_2_2({(for_for_acc_3_tmp[8:0]) , Drow_1_sva_3}, ~((~(((~((~(or_dcpl_22
          & (~ exit_for_for_1_sva_1))) & for_stage_0_1)) & slc_exs_7_tmp_tmp) | and_85_cse))
          | (fsm_output[0])))) & (signext_9_1(~((~(and_85_cse | slc_exs_7_tmp_tmp))
          | (fsm_output[0]))));
      exit_for_for_sva <= (MUX_s_1_2_2({(MUX_s_1_2_2({exit_for_for_sva , (exit_for_for_sva_dfm_1_mx0
          & (~ exit_for_for_1_sva_1))}, for_stage_0_1)) , exit_for_for_sva}, fsm_output[2]))
          & (~ (fsm_output[0]));
      Kcolumn_1_sva <= (MUX_v_2_2_2({(~((~((MUX_v_2_2_2({Kcolumn_1_sva , Kcolumn_1_sva_1},
          and_dcpl_54)) | (signext_2_1(~((~((~((~ exit_for_for_1_sva_1) & and_61_cse))
          & for_stage_0_1)) | and_dcpl_54 | and_dcpl_56))))) | ({{1{and_dcpl_56}},
          and_dcpl_56}))) , Kcolumn_1_sva}, and_85_cse)) & (signext_2_1(~ (fsm_output[0])));
      exit_for_for_for_sva <= (MUX_s_1_2_2({(MUX_s_1_2_2({exit_for_for_for_sva ,
          ((MUX_s_1_2_2({exit_for_for_for_sva_dfm_1_mx0 , ((~ (for_for_for_acc_itm[1]))
          & (for_for_acc_3_tmp[9]))}, exit_for_for_for_1_sva_1)) & (~ exit_for_for_1_sva_1))},
          for_stage_0_1)) , exit_for_for_for_sva}, fsm_output[2])) & (~ (fsm_output[0]));
      Krow_1_sva <= (MUX_v_2_2_2({(~((~(((MUX_v_2_2_2({(Krow_1_sva | ({{1{and_dcpl_54}},
          and_dcpl_54})) , Krow_1_sva_1}, (for_stage_0_1 & and_61_cse & nor_8_m1c)
          | (and_dcpl_54 & (~ (for_for_for_acc_itm[1]))))) & (signext_2_1(~(and_dcpl_54
          & (for_for_for_acc_itm[1]))))) | (signext_2_1((~ and_61_cse) & for_stage_0_1
          & nor_8_m1c)))) | ({{1{and_dcpl_56}}, and_dcpl_56}))) , Krow_1_sva}, and_85_cse))
          & (signext_2_1(~ (fsm_output[0])));
      for_stage_0_1 <= (MUX_s_1_2_2({for_stage_0 , for_stage_0_1}, ~((fsm_output[2])
          | (fsm_output[0])))) | (fsm_output[0]);
      Result_1_sva <= (MUX_s_1_2_2({Result_1_sva , (MUX_s_1_2_2({((MUX_s_1_2_2({Result_1_sva_dfm_mx0
          , (Result_1_sva_dfm_mx0 & reg_Drow_1_sva_1_tmp)}, exit_for_for_for_1_sva))
          & (~ exit_for_for_1_sva)) , Result_1_sva}, or_dcpl_45))}, fsm_output[2]))
          & (~ (fsm_output[0]));
      Result_sg1_sva <= (MUX1HOT_v_6_3_2({({{5{exit_for_for_for_1_sva}}, exit_for_for_for_1_sva})
          , (for_for_for_for_else_ac_fixed_cctor_sva[6:1]) , Result_sg1_sva}, {(~(and_120_tmp
          | nor_30_tmp)) , (and_120_tmp & (~ nor_30_tmp)) , nor_30_tmp})) & (signext_6_1(~((and_85_cse
          & and_dcpl_65) | (fsm_output[0]))));
      Result_sg2_sva <= (MUX_s_1_2_2({Result_sg2_sva , (MUX_s_1_2_2({((MUX_s_1_2_2({Result_sg2_sva_dfm_mx0
          , (Result_sg2_sva_dfm_mx0 & reg_Drow_1_sva_1_tmp)}, exit_for_for_for_1_sva))
          & (~ exit_for_for_1_sva)) , Result_sg2_sva}, or_dcpl_45))}, fsm_output[2]))
          & (~ (fsm_output[0]));
      exit_for_lpi_1_dfm <= (for_acc_1_tmp[9]) & exit_for_for_1_sva_1;
      exit_for_for_for_1_sva <= exit_for_for_for_1_sva_1;
      for_for_for_for_lor_lpi_1_dfm <= (for_for_for_for_oelse_2_acc_itm[1]) | (z_out[10])
          | (for_for_for_for_acc_1_tmp[9]) | (for_for_for_for_acc_1_tmp[10]);
  ...
  assign mux_47_nl = MUX_v_9_2_2({Drow_1_sva_3 , ({1'b0 , Result_sg2_sva , Result_sg1_sva
      , Result_1_sva})}, fsm_output[2]);
  assign mux_46_nl = MUX_v_6_2_2({(signext_6_2(Krow_1_sva + 2'b11)) , ({1'b0 , (readslicef_12_5_7(conv_u2u_24_12(conv_u2u_8_12(in_rsc_singleport_data_out)
      * conv_u2u_5_12({for_for_for_for_else_mux_itm , 1'b0 , ({{1{for_for_for_for_else_mux_1_itm}},
      for_for_for_for_else_mux_1_itm})}))))})}, fsm_output[2]);
  assign xz_out = conv_u2u_9_11(mux_47_nl) + conv_s2u_6_11(mux_46_nl);
