...
//  Generated date: Sat Apr 20 18:22:36 2019
// ----------------------------------------------------------------------
...
module Convolotion_core (
  ...
  always begin : core
    ...
    reg [10:0] conv1_sva;
    reg [10:0] conv2_sva;
    reg for_for_for_for_lor_1_lpi_1_dfm;
    ...
    reg [1:0] Krow_1_sva_dfm_1;
    reg [1:0] Kcolumn_1_sva_dfm;
    reg exit_for_for_for_sva_dfm_1;
    reg exit_for_for_for_1_sva;
    reg [9:0] Drow_1_sva_1;
    reg [5:0] Result_sg1_sva_dfm_2;
    reg [1:0] Krow_1_sva_dfm_3;
    reg [1:0] Kcolumn_1_sva_dfm_2;
    reg exit_for_for_sva_dfm_1;
    ...
    reg [8:0] Drow_1_sva_dfm_3;
    reg [2:0] for_for_for_for_else_acc_6_sdt;
    reg [2:0] for_for_for_for_else_acc_7_psp;
    reg exit_for_for_for_1_sva_tcond;
    reg in_rsc_singleport_re_reg_var;
    reg out_rsc_singleport_we_reg_var;
    reg Result_sg2_sva_dfm_1;
    reg [5:0] Result_sg1_sva_dfm_3;
    reg Result_1_sva_dfm_1;
    reg exit_for_for_for_1_sva_tcond_1;
    reg last_clk;
    ...
    reg[0:0] for_for_for_mux_7_nl;
    reg[0:0] for_for_for_mux_nl;
    reg[0:0] for_for_for_mux_2_nl;
    begin : mainExit
      forever begin : main
        ...
        begin : for_0Exit
          forever begin : for_0
            ...
            out_rsc_singleport_addr_reg_sg1 <= 9'b0;
            out_rsc_singleport_we_reg <= 1'b1;
            if ( for_stage_0_1 ) begin
              for_for_for_for_lor_sva_1 = 1'b0;
              conv1_sva = conv_s2s_3_11(conv_u2s_2_3(Kcolumn_1_sva) + 3'b111) + conv_u2s_9_11(Dcolumn_1_sva_2);
              conv2_sva = conv_s2s_2_11(Krow_1_sva + 2'b11) + conv_u2s_9_11(Drow_1_sva_3);
              for_for_for_for_lor_1_lpi_1_dfm = (conv2_sva[10]) | (conv1_sva[9])
                  | (conv1_sva[10]);
              if ( for_for_for_for_lor_1_lpi_1_dfm ) begin
              end
              else begin
                for_for_for_for_lor_sva_1 = readslicef_2_1_1(((~ (conv2_sva[10:9]))
                    + 2'b1));
              end
              for_for_for_for_lor_lpi_1_dfm = for_for_for_for_lor_sva_1 | for_for_for_for_lor_1_lpi_1_dfm;
              if ( for_for_for_for_lor_lpi_1_dfm ) begin
              end
              else begin
            ...
            if ( for_stage_0_1 ) begin
              ...
              if ( for_for_for_for_lor_lpi_1_dfm ) begin
                ...
                for_for_for_for_else_acc_6_sdt = conv_u2u_2_3(Krow_1_sva) + conv_u2u_2_3(Kcolumn_1_sva);
                for_for_for_for_else_acc_7_psp = conv_u2u_2_3(for_for_for_for_else_acc_6_sdt[2:1])
                    + conv_u2u_2_3(Krow_1_sva);
                for_for_for_for_else_mux_itm = MUX_v_2_16_2({2'b1 , 2'b10 , 2'b1
                    , 2'b10 , 2'b0 , 2'b10 , 2'b1 , 2'b10 , 2'b1 , 2'b0 , 2'b0 ,
                    2'b0 , 2'b0 , 2'b0 , 2'b0 , 2'b0}, {for_for_for_for_else_acc_7_psp
                    , (for_for_for_for_else_acc_6_sdt[0])});
                for_for_for_for_else_mux_1_itm = MUX_s_1_16_2({1'b0 , 1'b0 , 1'b0
                    , 1'b0 , 1'b1 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0
                    , 1'b0 , 1'b0 , 1'b0 , 1'b0}, {for_for_for_for_else_acc_7_psp
                    , (for_for_for_for_else_acc_6_sdt[0])});
              end
              ...
              if ( exit_for_for_for_for_sva ) begin
                ...
                exit_for_for_for_sva_1 = ~ (readslicef_3_1_2((({1'b1 , Kcolumn_1_sva_1})
                    + 3'b1)));
                Krow_1_sva_dfm_1 = Krow_1_sva_1 & ({{1{exit_for_for_for_sva_1}},
                    exit_for_for_for_sva_1});
              ...
              exit_for_for_for_1_sva = exit_for_for_for_for_sva & exit_for_for_for_sva_dfm_1;
              if ( exit_for_for_for_1_sva ) begin
                Drow_slc_Drow_1_itm = Drow_1_sva_3;
                Dcolumn_slc_Dcolumn_1_itm = Dcolumn_1_sva_2;
                Drow_1_sva_1 = conv_u2u_9_10(Drow_1_sva_3) + 10'b1;
                Drow_1_sva_dfm_3 = Drow_1_sva_1[8:0];
                Krow_1_sva_dfm_3 = Krow_1_sva_dfm_1 & (signext_2_1(Drow_1_sva_1[9]));
                Kcolumn_1_sva_dfm_2 = Kcolumn_1_sva_dfm & (signext_2_1(Drow_1_sva_1[9]));
              ...
              exit_for_for_1_sva = exit_for_for_for_1_sva & exit_for_for_sva_dfm_1;
              if ( exit_for_for_1_sva ) begin
                Dcolumn_1_sva_1 = conv_u2u_9_10(Dcolumn_1_sva_2) + 10'b1;
              end
              exit_for_lpi_1_dfm = (Dcolumn_1_sva_1[9]) & exit_for_for_1_sva;
              if ( exit_for_lpi_1_dfm ) begin
                for_stage_0 = 1'b0;
              end
              else begin
                Drow_1_sva_3 = Drow_1_sva_dfm_3 & (signext_9_1(~ exit_for_for_1_sva));
                Dcolumn_1_sva_2 = MUX_v_9_2_2({Dcolumn_1_sva_2 , (Dcolumn_1_sva_1[8:0])},
                    exit_for_for_1_sva);
                Krow_1_sva = Krow_1_sva_dfm_3 & (signext_2_1(~ exit_for_for_1_sva));
                Kcolumn_1_sva = Kcolumn_1_sva_dfm_2 & (signext_2_1(~ exit_for_for_1_sva));
                exit_for_for_sva = exit_for_for_sva_dfm_1 & (~ exit_for_for_1_sva);
                for_for_for_mux_7_nl = MUX_s_1_2_2({exit_for_for_for_sva_dfm_1 ,
                    (exit_for_for_for_sva_dfm_1 & (Drow_1_sva_1[9]))}, exit_for_for_for_1_sva);
                exit_for_for_for_sva = (for_for_for_mux_7_nl) & (~ exit_for_for_1_sva);
              end
            end
            ...
            begin : unreg_outs_lp_2Exit
              forever begin : unreg_outs_lp_2
                ...
                if ( for_stage_0_1 ) begin
                  if ( for_for_for_for_lor_lpi_1_dfm ) begin
                    ...
                    slc_sat_sva = conv_u2u_8_9({Result_sg2_sva , Result_sg1_sva ,
                        Result_1_sva}) + conv_u2u_5_9(readslicef_12_5_7(conv_u2u_24_12(conv_u2u_8_12(in_rsc_singleport_data_out)
                    ...
                    Result_sg1_sva_dfm = for_for_for_for_else_ac_fixed_cctor_sva[6:1];
            ...
            if ( rst )
              disable mainExit;
            if ( for_stage_0_1 ) begin
              if ( exit_for_for_for_1_sva_tcond ) begin
                Result_sg1_sva_dfm_2 = Result_sg1_sva_dfm & (signext_6_1(Drow_1_sva_1[9]));
              end
              else begin
              ...
              if ( exit_for_lpi_1_dfm ) begin
                ...
                for_for_for_mux_nl = MUX_s_1_2_2({Result_sg2_sva_dfm , (Result_sg2_sva_dfm
                    & (Drow_1_sva_1[9]))}, exit_for_for_for_1_sva);
                Result_sg2_sva = (for_for_for_mux_nl) & (~ exit_for_for_1_sva);
                Result_sg1_sva = Result_sg1_sva_dfm_2 & (signext_6_1(~ exit_for_for_1_sva));
                for_for_for_mux_2_nl = MUX_s_1_2_2({Result_1_sva_dfm , (Result_1_sva_dfm
                    & (Drow_1_sva_1[9]))}, exit_for_for_for_1_sva);
                Result_1_sva = (for_for_for_mux_2_nl) & (~ exit_for_for_1_sva);
              end
            end
            if ( ~(for_stage_0 | for_stage_0_1) )
              disable for_0Exit;
    ...
    Result_1_sva_dfm = 1'b0;
    Result_sg1_sva_dfm = 6'b0;
    Result_sg2_sva_dfm = 1'b0;
