...
//  Generated date: Sat Apr 20 18:31:22 2019
// ----------------------------------------------------------------------
...
module Convolotion_core (
  ...
  assign or_24_cse = ((fsm_output[2]) & for_for_for_for_lor_lpi_4_dfm) | (fsm_output[3])
      | (fsm_output[1]);
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      exit_for_for_for_for <= 1'b0;
      for_for_for_for_lor_lpi_4_dfm <= 1'b0;
    end
    else begin
      Krow_1_sva <= (MUX_v_2_2_2({z_out , Krow_1_sva}, fsm_output[2])) & (signext_2_1(~(or_dcpl_19
      ...
      exit_for_for_for_for <= ~ (z_out_1[1]);
      for_for_for_for_lor_lpi_4_dfm <= (for_for_for_for_oelse_2_acc_itm[1]) | (z_out_2[10])
          | (z_out_3[9]) | (z_out_3[10]);
    end
  end
  assign mux_10_nl = MUX_v_2_2_2({Krow_1_sva , Kcolumn_1_sva}, fsm_output[3]);
  assign xz_out = (mux_10_nl) + 2'b1;
  assign z_out = xz_out[1:0];
  assign xz_out_1 = z_out + 2'b1;
  assign z_out_1 = xz_out_1[1:0];
  assign mux_7_nl = MUX_v_2_2_2({(Krow_1_sva + 2'b11) , 2'b1}, fsm_output[4]);
