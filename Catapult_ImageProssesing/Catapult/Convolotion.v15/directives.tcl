...
//  
project new
solution file add {./ESL_CA2.c} -type C++
...
go analyze
directive set -DESIGN_HIERARCHY Convolotion
...
go compile
directive set /Convolotion/core/main -PIPELINE_INIT_INTERVAL 0
directive set /Convolotion/core/for -PIPELINE_INIT_INTERVAL 0
directive set /Convolotion/core/for:for -PIPELINE_INIT_INTERVAL 0
directive set /Convolotion/core/for:for:for -PIPELINE_INIT_INTERVAL 0
directive set /Convolotion/core/for:for:for:for -PIPELINE_INIT_INTERVAL 0
directive set /Convolotion/core/for -UNROLL no
directive set /Convolotion/core/for:for -UNROLL no
directive set /Convolotion/core/for:for:for:for -UNROLL 3
directive set /Convolotion/core/for:for:for -UNROLL no
go architect
go extract
