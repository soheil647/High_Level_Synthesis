...
//  Generated date: Sat Apr 20 18:41:28 2019
// ----------------------------------------------------------------------
...
module Convolotion_core (
  ...
  always begin : core
    ...
    reg [9:0] for_for_1_for_for_acc_3_psp_sva;
    ...
    reg [8:0] for_for_1_acc_3_psp_sva;
    ...
    reg [1:0] Krow_3_sva;
    reg [10:0] conv1_2_sva;
    reg [9:0] for_for_2_for_for_acc_3_psp_sva;
          ...
          forever begin : for_0
            ...
            begin : for_forExit
              forever begin : for_for
                ...
                Kcolumn_2_sva = 2'b0;
                begin : for_for_1_forExit
                  forever begin : for_for_1_for
                    ...
                    Krow_2_sva = 2'b0;
                    begin : for_for_1_for_forExit
                      forever begin : for_for_1_for_for
                        ...
                        out_rsc_singleport_addr_reg_sg1 <= 9'b0;
                        out_rsc_singleport_we_reg <= 1'b1;
                        conv1_1_sva = conv_s2s_2_11(Kcolumn_2_sva + 2'b11) + conv_u2s_9_11(Dcolumn_1_sva_2);
                        for_for_1_for_for_acc_3_psp_sva = conv_s2s_2_10(Krow_2_sva
                            + 2'b11) + conv_u2s_9_10(Drow_4_sva);
                        for_for_for_for_lor_5_lpi_4_dfm_st = (for_for_1_for_for_acc_3_psp_sva[9])
                            | (conv1_1_sva[9]) | (conv1_1_sva[10]);
                        if ( for_for_for_for_lor_5_lpi_4_dfm_st ) begin
                        end
                        else begin
                          in_rsc_singleport_re_reg <= 1'b0;
                          in_rsc_singleport_addr_reg_1 <= conv1_1_sva[8:0];
                          in_rsc_singleport_addr_reg_sg1 <= (for_for_1_for_for_acc_3_psp_sva[8:0])
                        ...
                        for_for_1_for_for_slc_itm = readslicef_3_1_2((({1'b1 , Krow_2_sva_1})
                            + 3'b1));
                        in_rsc_singleport_addr_reg_1 <= 9'b0;
                        in_rsc_singleport_addr_reg_sg1 <= 9'b0;
                        in_rsc_singleport_re_reg <= 1'b1;
                        ...
                        if ( ~ for_for_1_for_for_slc_itm )
                          disable for_for_1_for_forExit;
                ...
                for_for_1_acc_3_psp_sva = Drow_4_sva + 9'b1;
                in_rsc_singleport_addr_reg_1 <= 9'b0;
                in_rsc_singleport_addr_reg_sg1 <= 9'b0;
                in_rsc_singleport_re_reg <= 1'b1;
                out_rsc_singleport_data_in_reg_sg1 <= 6'b0;
                ...
                Kcolumn_3_sva = 2'b0;
                begin : for_for_2_forExit
                  forever begin : for_for_2_for
                    ...
                    Krow_3_sva = 2'b0;
                    begin : for_for_2_for_forExit
                      forever begin : for_for_2_for_for
                        ...
                        out_rsc_singleport_addr_reg_sg1 <= 9'b0;
                        out_rsc_singleport_we_reg <= 1'b1;
                        conv1_2_sva = conv_s2s_2_11(Kcolumn_3_sva + 2'b11) + conv_u2s_9_11(Dcolumn_1_sva_2);
                        for_for_2_for_for_acc_3_psp_sva = conv_s2u_2_10(Krow_3_sva
                            + 2'b11) + conv_u2u_9_10(for_for_1_acc_3_psp_sva);
                        for_for_for_for_lor_4_lpi_4_dfm_st = (for_for_2_for_for_acc_3_psp_sva[9])
                            | (conv1_2_sva[9]) | (conv1_2_sva[10]);
                        if ( for_for_for_for_lor_4_lpi_4_dfm_st ) begin
                        end
                        else begin
                          in_rsc_singleport_re_reg <= 1'b0;
                          in_rsc_singleport_addr_reg_1 <= conv1_2_sva[8:0];
                          in_rsc_singleport_addr_reg_sg1 <= (for_for_2_for_for_acc_3_psp_sva[8:0])
                              + conv_s2u_2_9(conv1_2_sva[10:9]);
                        end
                        begin : waitLoop6Exit
                        ...
                        for_for_2_for_for_slc_itm = readslicef_3_1_2((({1'b1 , Krow_3_sva_1})
                            + 3'b1));
                        in_rsc_singleport_addr_reg_1 <= 9'b0;
                        in_rsc_singleport_addr_reg_sg1 <= 9'b0;
                        in_rsc_singleport_re_reg <= 1'b1;
                        ...
                        if ( ~ for_for_2_for_for_slc_itm )
                          disable for_for_2_for_forExit;
                ...
                Drow_1_sva = conv_u2u_9_10(for_for_1_acc_3_psp_sva) + 10'b1;
                in_rsc_singleport_addr_reg_1 <= 9'b0;
                in_rsc_singleport_addr_reg_sg1 <= 9'b0;
                in_rsc_singleport_re_reg <= 1'b1;
                out_rsc_singleport_data_in_reg_sg1 <= 6'b0;
                  ...
                  forever begin : for_for_3_for
                    ...
                    begin : for_for_3_for_forExit
                      forever begin : for_for_3_for_for
                        ...
                        conv2_sva = conv_s2s_2_11(Krow_1_sva + 2'b11) + conv_u2s_9_11(Drow_1_sva[8:0]);
                        ...
                        for_for_3_for_for_slc_itm = readslicef_3_1_2((({1'b1 , Krow_1_sva_1})
                            + 3'b1));
                        in_rsc_singleport_addr_reg_1 <= 9'b0;
                        in_rsc_singleport_addr_reg_sg1 <= 9'b0;
                        in_rsc_singleport_re_reg <= 1'b1;
                        ...
                        if ( ~ for_for_3_for_for_slc_itm )
                          disable for_for_3_for_forExit;
                ...
                out_rsc_singleport_we_reg <= 1'b0;
                out_rsc_singleport_addr_reg_1 <= Dcolumn_1_sva_2;
                out_rsc_singleport_addr_reg_sg1 <= Drow_1_sva[8:0];
                ...
                Drow_4_sva = (Drow_1_sva[8:0]) + 9'b1;
                in_rsc_singleport_addr_reg_1 <= 9'b0;
                in_rsc_singleport_addr_reg_sg1 <= 9'b0;
                in_rsc_singleport_re_reg <= 1'b1;
                out_rsc_singleport_data_in_reg_sg1 <= 6'b0;
