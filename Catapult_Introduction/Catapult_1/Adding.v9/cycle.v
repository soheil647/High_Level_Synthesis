...
//  Generated date: Tue Apr 09 16:42:24 2019
// ----------------------------------------------------------------------
      ...
      forever begin : main
        ...
        begin : out_0Exit
          forever begin : out_0
            ...
            exit_out_sva_1 = 1'b0;
            out_i_1_sva_1 = 4'b0;
            Temp2_sva_1 = Temp2_sva + conv_u2u_9_64(readslicef_11_9_2((conv_u2u_10_11({(conv_u2u_8_9(A_1_sva)
            ...
            if ( exit_in_sva ) begin
              ...
              exit_out_sva_1 = ~ (readslicef_5_1_4((conv_u2s_4_5(out_i_1_sva_1) +
                  5'b10101)));
            end
            exit_out_lpi_1_dfm = exit_out_sva_1 & exit_in_sva;
            if ( exit_out_lpi_1_dfm ) begin
            end
            else begin
              out_i_1_sva = MUX_v_4_2_2({out_i_1_sva , out_i_1_sva_1}, exit_in_sva);
              in_i_1_sva = in_i_1_sva_1 & (signext_3_1(~ exit_in_sva));
            end
            begin : waitLoop2Exit
            ...
            if ( exit_in_sva ) begin
              Temp2_sva_dfm = conv_u2u_128_64(Temp2_sva_1 * conv_u2u_16_64(out_mul_1_itm));
            end
            else begin
