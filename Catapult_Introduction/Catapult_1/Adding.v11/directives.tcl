...
go compile
directive set /Adding/core/in -UNROLL no
directive set /Adding/core -DESIGN_GOAL area
directive set /Adding/core/main -PIPELINE_INIT_INTERVAL 0
directive set /Adding/core/out -PIPELINE_INIT_INTERVAL 0
directive set /Adding/core/in -PIPELINE_INIT_INTERVAL 0
directive set /Adding/core/out -UNROLL yes
go architect
go extract
