...
# Loop constraints
directive set /Adding/core/main CSTEPS_FROM {{. == 14}}
directive set /Adding/core/main/out-1:in CSTEPS_FROM {{. == 1} {.. == 1}}
directive set /Adding/core/main/out-2:in CSTEPS_FROM {{. == 1} {.. == 3}}
directive set /Adding/core/main/out-3:in CSTEPS_FROM {{. == 1} {.. == 4}}
directive set /Adding/core/main/out-4:in CSTEPS_FROM {{. == 1} {.. == 5}}
directive set /Adding/core/main/out-5:in CSTEPS_FROM {{. == 1} {.. == 6}}
directive set /Adding/core/main/out-6:in CSTEPS_FROM {{. == 1} {.. == 7}}
directive set /Adding/core/main/out-7:in CSTEPS_FROM {{. == 1} {.. == 8}}
directive set /Adding/core/main/out-8:in CSTEPS_FROM {{. == 1} {.. == 9}}
directive set /Adding/core/main/out-9:in CSTEPS_FROM {{. == 1} {.. == 10}}
directive set /Adding/core/main/out-10:in CSTEPS_FROM {{. == 1} {.. == 11}}
directive set /Adding/core/main/out-11:in CSTEPS_FROM {{. == 1} {.. == 12}}
...
directive set /Adding/core/main/out:io_write(Temp:rsc.d) CSTEPS_FROM {{.. == 13}}
...
directive set /Adding/core/main/out-1:mul CSTEPS_FROM {{.. == 3}}
...
directive set /Adding/core/main/out-2:mul CSTEPS_FROM {{.. == 4}}
...
directive set /Adding/core/main/out-3:mul CSTEPS_FROM {{.. == 5}}
...
directive set /Adding/core/main/out-4:mul CSTEPS_FROM {{.. == 6}}
...
directive set /Adding/core/main/out-5:mul CSTEPS_FROM {{.. == 7}}
...
directive set /Adding/core/main/out-6:mul CSTEPS_FROM {{.. == 8}}
...
directive set /Adding/core/main/out-7:mul CSTEPS_FROM {{.. == 9}}
...
directive set /Adding/core/main/out-8:mul CSTEPS_FROM {{.. == 10}}
...
directive set /Adding/core/main/out-9:mul CSTEPS_FROM {{.. == 11}}
...
directive set /Adding/core/main/out-10:mul CSTEPS_FROM {{.. == 12}}
...
directive set /Adding/core/main/out-11:mul CSTEPS_FROM {{.. == 13}}
