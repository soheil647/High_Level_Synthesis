...
directive set /Adding/core/main/out CSTEPS_FROM {{. == 1} {.. == 1}}
directive set /Adding/core/main/out/in CSTEPS_FROM {{. == 1} {.. == 0}}
...
directive set /Adding/core/main/out/out:mul CSTEPS_FROM {{.. == 1}}
